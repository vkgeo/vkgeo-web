(function() {
	...
	var dfs = {"am_pm":["kíkíríg","ngəgógəle"],"day_name":["sɔ́ndɔ","mɔ́ndi","sɔ́ndɔ məlú mə́bɛ̌","sɔ́ndɔ məlú mə́lɛ́","sɔ́ndɔ məlú mə́nyi","fúladé","séradé"],"day_short":["sɔ́n","mɔ́n","smb","sml","smn","fúl","sér"],"era":["oyk","ayk"],"era_name":["osúsúa Yésus kiri","ámvus Yésus Kirís"],"month_name":["ngɔn osú","ngɔn bɛ̌","ngɔn lála","ngɔn nyina","ngɔn tána","ngɔn saməna","ngɔn zamgbála","ngɔn mwom","ngɔn ebulú","ngɔn awóm","ngɔn awóm ai dziá","ngɔn awóm ai bɛ̌"],"month_short":["ngo","ngb","ngl","ngn","ngt","ngs","ngz","ngm","nge","nga","ngad","ngab"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Kamərún" };
