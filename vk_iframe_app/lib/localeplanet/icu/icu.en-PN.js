(function() {
	...
	icu.getCountry = function() { return "PN" };
	icu.getCountryName = function() { return "Pitcairn Islands" };
	...
	icu.getLocale = function() { return "en-PN" };
	icu.getLocaleName = function() { return "English (Pitcairn Islands)" };
