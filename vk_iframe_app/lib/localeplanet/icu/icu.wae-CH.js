(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["Sunntag","Mäntag","Zištag","Mittwuč","Fróntag","Fritag","Samštag"],"day_short":["Sun","Män","Ziš","Mit","Fró","Fri","Sam"],"era":["v. Chr.","n. Chr"],"era_name":["v. Chr.","n. Chr"],"month_name":["Jenner","Hornig","Märze","Abrille","Meije","Bráčet","Heiwet","Öigšte","Herbštmánet","Wímánet","Wintermánet","Chrištmánet"],"month_short":["Jen","Hor","Mär","Abr","Mei","Brá","Hei","Öig","Her","Wím","Win","Chr"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Schwiz" };
	...
	icu.getLanguage = function() { return "wae" };
	icu.getLanguageName = function() { return "Walser" };
