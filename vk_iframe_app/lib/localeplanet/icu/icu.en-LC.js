(function() {
	...
	icu.getCountry = function() { return "LC" };
	icu.getCountryName = function() { return "St. Lucia" };
	...
	icu.getLocale = function() { return "en-LC" };
	icu.getLocaleName = function() { return "English (St. Lucia)" };
