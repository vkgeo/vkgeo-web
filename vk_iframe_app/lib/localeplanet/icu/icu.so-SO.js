(function() {
	...
	var dfs = {"am_pm":["sn.","gn."],"day_name":["Axad","Isniin","Talaado","Arbaco","Khamiis","Jimco","Sabti"],"day_short":["Axd","Isn","Tal","Arb","Kha","Jim","Sab"],"era":["CK","CD"],"era_name":["CK","CD"],"month_name":["Bisha Koobaad","Bisha Labaad","Bisha Saddexaad","Bisha Afraad","Bisha Shanaad","Bisha Lixaad","Bisha Todobaad","Bisha Sideedaad","Bisha Sagaalaad","Bisha Tobnaad","Bisha Kow iyo Tobnaad","Bisha Laba iyo Tobnaad"],"month_short":["Kob","Lab","Sad","Afr","Sha","Lix","Tod","Sid","Sag","Tob","KIT","LIT"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
