(function() {
	...
	var dfs = {"am_pm":["пре подне","поподне"],"day_name":["недјеља","понедјељак","уторак","сриједа","четвртак","петак","субота"],"day_short":["нед","пон","уто","сри","чет","пет","суб"],"era":["п. н. е.","н. е."],"era_name":["прије нове ере","нове ере"],"month_name":["јануар","фебруар","март","април","мај","јуни","јули","аугуст","септембар","октобар","новембар","децембар"],"month_short":["јан","феб","мар","апр","мај","јун","јул","ауг","сеп","окт","нов","дец"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguageName = function() { return "босански" };
	icu.getLocale = function() { return "bs-Cyrl-BA" };
	icu.getLocaleName = function() { return "босански (ћирилица, Босна и Херцеговина)" };
