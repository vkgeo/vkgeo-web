(function() {
	...
	icu.getLanguageName = function() { return "བོད་སྐད་" };
	icu.getLocale = function() { return "bo-CN" };
	icu.getLocaleName = function() { return "བོད་སྐད་ (རྒྱ་ནག)" };
