(function() {
	...
	var dfs = {"am_pm":["пе. чо.","па. чо."],"day_name":["Якшанбе","Душанбе","Сешанбе","Чоршанбе","Панҷшанбе","Ҷумъа","Шанбе"],"day_short":["Яшб","Дшб","Сшб","Чшб","Пшб","Ҷмъ","Шнб"],"era":["ПеМ","ПаМ"],"era_name":["Пеш аз милод","ПаМ"],"month_name":["Январ","Феврал","Март","Апрел","Май","Июн","Июл","Август","Сентябр","Октябр","Ноябр","Декабр"],"month_short":["Янв","Фев","Мар","Апр","Май","Июн","Июл","Авг","Сен","Окт","Ноя","Дек"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Тоҷикистон" };
	...
	icu.getLanguageName = function() { return "тоҷикӣ" };
	icu.getLocale = function() { return "tg-TJ" };
	icu.getLocaleName = function() { return "тоҷикӣ (Тоҷикистон)" };
