(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["якшәмбе","дүшәмбе","сишәмбе","чәршәмбе","пәнҗешәмбе","җомга","шимбә"],"day_short":["якш.","дүш.","сиш.","чәр.","пәнҗ.","җом.","шим."],"era":["б.э.к.","б.э."],"era_name":["безнең эрага кадәр","безнең эра"],"month_name":["гыйнвар","февраль","март","апрель","май","июнь","июль","август","сентябрь","октябрь","ноябрь","декабрь"],"month_short":["гыйн.","фев.","мар.","апр.","май","июнь","июль","авг.","сент.","окт.","нояб.","дек."],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguageName = function() { return "татар" };
	icu.getLocale = function() { return "tt-RU" };
	icu.getLocaleName = function() { return "татар (Россия)" };
