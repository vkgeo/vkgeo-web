(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["اَتھوار","ژٔنٛدرٕروار","بوٚموار","بودوار","برٛٮ۪سوار","جُمہ","بٹوار"],"day_short":["آتھوار","ژٔنٛدٕروار","بوٚموار","بودوار","برٛٮ۪سوار","جُمہ","بٹوار"],"era":["بی سی","اے ڈی"],"era_name":["قبٕل مسیٖح","عیٖسوی سنہٕ"],"month_name":["جنؤری","فرؤری","مارٕچ","اپریل","میٔ","جوٗن","جوٗلایی","اگست","ستمبر","اکتوٗبر","نومبر","دسمبر"],"month_short":["جنؤری","فرؤری","مارٕچ","اپریل","میٔ","جوٗن","جوٗلایی","اگست","ستمبر","اکتوٗبر","نومبر","دسمبر"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "ہِنٛدوستان" };
	...
	icu.getLanguage = function() { return "ks" };
	icu.getLanguageName = function() { return "کٲشُر" };
	icu.getLocale = function() { return "ks-IN" };
	icu.getLocaleName = function() { return "کٲشُر (ہِنٛدوستان)" };
