(function() {
	...
	icu.getCountry = function() { return "SJ" };
	icu.getCountryName = function() { return "Svalbard og Jan Mayen" };
	...
	icu.getLocale = function() { return "nb-SJ" };
	icu.getLocaleName = function() { return "norsk bokmål (Svalbard og Jan Mayen)" };
