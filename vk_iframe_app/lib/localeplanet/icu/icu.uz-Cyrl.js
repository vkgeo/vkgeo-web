(function() {
	...
	var dfs = {"am_pm":["ТО","ТК"],"day_name":["якшанба","душанба","сешанба","чоршанба","пайшанба","жума","шанба"],"day_short":["якш","душ","сеш","чор","пай","жум","шан"],"era":["м.а.","милодий"],"era_name":["милоддан аввалги","милодий"],"month_name":["январ","феврал","март","апрел","май","июн","июл","август","сентябр","октябр","ноябр","декабр"],"month_short":["янв","фев","мар","апр","май","июн","июл","авг","сен","окт","ноя","дек"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguageName = function() { return "ўзбекча" };
	icu.getLocale = function() { return "uz-Cyrl" };
	icu.getLocaleName = function() { return "ўзбекча (Кирил)" };
