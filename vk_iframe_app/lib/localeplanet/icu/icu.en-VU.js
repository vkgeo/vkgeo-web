(function() {
	...
	icu.getCountry = function() { return "VU" };
	icu.getCountryName = function() { return "Vanuatu" };
	...
	icu.getLocale = function() { return "en-VU" };
	icu.getLocaleName = function() { return "English (Vanuatu)" };
