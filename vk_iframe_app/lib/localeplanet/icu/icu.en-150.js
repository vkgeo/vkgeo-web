(function() {
	...
	icu.getCountry = function() { return "150" };
	icu.getCountryName = function() { return "Europe" };
	...
	icu.getLocale = function() { return "en-150" };
	icu.getLocaleName = function() { return "English (Europe)" };
