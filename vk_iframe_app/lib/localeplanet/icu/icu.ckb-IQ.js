(function() {
	...
	var dfs = {"am_pm":["ب.ن","د.ن"],"day_name":["یەکشەممە","دووشەممە","سێشەممە","چوارشەممە","پێنجشەممە","ھەینی","شەممە"],"day_short":["یەکشەممە","دووشەممە","سێشەممە","چوارشەممە","پێنجشەممە","ھەینی","شەممە"],"era":["پێش زایین","زایینی"],"era_name":["پێش زایین","زایینی"],"month_name":["کانوونی دووەم","شوبات","ئازار","نیسان","ئایار","حوزەیران","تەمووز","ئاب","ئەیلوول","تشرینی یەکەم","تشرینی دووەم","کانونی یەکەم"],"month_short":["کانوونی دووەم","شوبات","ئازار","نیسان","ئایار","حوزەیران","تەمووز","ئاب","ئەیلوول","تشرینی یەکەم","تشرینی دووەم","کانونی یەکەم"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "عێراق" };
	...
	icu.getLanguage = function() { return "ckb" };
	icu.getLanguageName = function() { return "کوردیی ناوەندی" };
	icu.getLocale = function() { return "ckb-IQ" };
	icu.getLocaleName = function() { return "کوردیی ناوەندی (عێراق)" };
