(function() {
	...
	icu.getCountry = function() { return "DG" };
	icu.getCountryName = function() { return "Diego Garcia" };
	...
	icu.getLocale = function() { return "en-DG" };
	icu.getLocaleName = function() { return "English (Diego Garcia)" };
