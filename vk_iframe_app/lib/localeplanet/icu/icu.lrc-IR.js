(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],"day_short":["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],"era":["AP"],"era_name":["AP"],"month_name":["Farvardin","Ordibehesht","Khordad","Tir","Mordad","Shahrivar","Mehr","Aban","Azar","Dey","Bahman","Esfand"],"month_short":["Farvardin","Ordibehesht","Khordad","Tir","Mordad","Shahrivar","Mehr","Aban","Azar","Dey","Bahman","Esfand"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "IR" };
	...
	icu.getLocale = function() { return "lrc-IR" };
	icu.getLocaleName = function() { return "لۊری شومالی (IR)" };
