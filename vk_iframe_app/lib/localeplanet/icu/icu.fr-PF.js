(function() {
	...
	icu.getCountry = function() { return "PF" };
	icu.getCountryName = function() { return "Polynésie française" };
	...
	icu.getLocale = function() { return "fr-PF" };
	icu.getLocaleName = function() { return "français (Polynésie française)" };
