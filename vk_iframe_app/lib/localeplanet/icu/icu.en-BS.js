(function() {
	...
	icu.getCountry = function() { return "BS" };
	icu.getCountryName = function() { return "Bahamas" };
	...
	icu.getLocale = function() { return "en-BS" };
	icu.getLocaleName = function() { return "English (Bahamas)" };
