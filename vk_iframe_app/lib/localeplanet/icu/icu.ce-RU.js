(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["кӀира","оршот","шинара","кхаара","еара","пӀераска","шуот"],"day_short":["кӀи","ор","ши","кха","еа","пӀе","шуо"],"era":["в. э. тӀ. я","в. э"],"era_name":["Ӏийса пайхамар вина де кхачале","Ӏийса пайхамар вина дийнахь дуьйна"],"month_name":["январь","февраль","март","апрель","май","июнь","июль","август","сентябрь","октябрь","ноябрь","декабрь"],"month_short":["янв","фев","мар","апр","май","июн","июл","авг","сен","окт","ноя","дек"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Росси" };
	...
	icu.getLanguage = function() { return "ce" };
	icu.getLanguageName = function() { return "нохчийн" };
	icu.getLocale = function() { return "ce-RU" };
	icu.getLocaleName = function() { return "нохчийн (Росси)" };
