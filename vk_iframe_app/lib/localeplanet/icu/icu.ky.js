(function() {
	...
	var dfs = {"am_pm":["таңкы","түштөн кийинки"],"day_name":["жекшемби","дүйшөмбү","шейшемби","шаршемби","бейшемби","жума","ишемби"],"day_short":["жек.","дүй.","шейш.","шарш.","бейш.","жума","ишм."],"era":["б.з.ч.","б.з."],"era_name":["биздин заманга чейин","биздин заман"],"month_name":["январь","февраль","март","апрель","май","июнь","июль","август","сентябрь","октябрь","ноябрь","декабрь"],"month_short":["янв.","фев.","мар.","апр.","май","июн.","июл.","авг.","сен.","окт.","ноя.","дек."],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguageName = function() { return "кыргызча" };
	icu.getLocale = function() { return "ky" };
	icu.getLocaleName = function() { return "кыргызча" };
