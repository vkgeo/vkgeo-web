(function() {
	...
	icu.getCountry = function() { return "MS" };
	icu.getCountryName = function() { return "Montserrat" };
	...
	icu.getLocale = function() { return "en-MS" };
	icu.getLocaleName = function() { return "English (Montserrat)" };
