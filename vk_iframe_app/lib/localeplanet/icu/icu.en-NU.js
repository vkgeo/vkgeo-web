(function() {
	...
	icu.getCountry = function() { return "NU" };
	icu.getCountryName = function() { return "Niue" };
	...
	icu.getLocale = function() { return "en-NU" };
	icu.getLocaleName = function() { return "English (Niue)" };
