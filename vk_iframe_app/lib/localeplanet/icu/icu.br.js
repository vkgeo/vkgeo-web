(function() {
	...
	var dfs = {"am_pm":["A.M.","G.M."],"day_name":["Sul","Lun","Meurzh","Mercʼher","Yaou","Gwener","Sadorn"],"day_short":["Sul","Lun","Meu.","Mer.","Yaou","Gwe.","Sad."],"era":["a-raok J.K.","goude J.K."],"era_name":["a-raok Jezuz-Krist","goude Jezuz-Krist"],"month_name":["Genver","Cʼhwevrer","Meurzh","Ebrel","Mae","Mezheven","Gouere","Eost","Gwengolo","Here","Du","Kerzu"],"month_short":["Gen.","Cʼhwe.","Meur.","Ebr.","Mae","Mezh.","Goue.","Eost","Gwen.","Here","Du","Kzu."],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
