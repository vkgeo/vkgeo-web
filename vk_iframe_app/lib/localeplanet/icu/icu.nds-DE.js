(function() {
	...
	icu.getCountryName = function() { return "DE" };
	...
	icu.getLanguageName = function() { return "nds" };
	icu.getLocale = function() { return "nds-DE" };
	icu.getLocaleName = function() { return "nds (DE)" };
