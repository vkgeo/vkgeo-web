(function() {
	...
	icu.getCountry = function() { return "IM" };
	icu.getCountryName = function() { return "Ellan Vannin" };
	...
	icu.getLocale = function() { return "gv-IM" };
	icu.getLocaleName = function() { return "Gaelg (Ellan Vannin)" };
