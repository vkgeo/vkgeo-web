(function() {
	...
	icu.getCountryName = function() { return "Singapura" };
	...
	icu.getLanguageName = function() { return "Melayu" };
	icu.getLocale = function() { return "ms-SG" };
	icu.getLocaleName = function() { return "Melayu (Singapura)" };
