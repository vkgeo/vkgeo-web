(function() {
	...
	icu.getCountry = function() { return "VG" };
	icu.getCountryName = function() { return "British Virgin Islands" };
	...
	icu.getLocale = function() { return "en-VG" };
	icu.getLocaleName = function() { return "English (British Virgin Islands)" };
