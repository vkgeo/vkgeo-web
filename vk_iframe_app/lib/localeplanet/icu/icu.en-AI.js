(function() {
	...
	icu.getCountry = function() { return "AI" };
	icu.getCountryName = function() { return "Anguilla" };
	...
	icu.getLocale = function() { return "en-AI" };
	icu.getLocaleName = function() { return "English (Anguilla)" };
