(function() {
	...
	icu.getCountry = function() { return "CC" };
	icu.getCountryName = function() { return "Cocos (Keeling) Islands" };
	...
	icu.getLocale = function() { return "en-CC" };
	icu.getLocaleName = function() { return "English (Cocos [Keeling] Islands)" };
