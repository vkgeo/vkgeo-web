(function() {
	...
	var dfs = {"am_pm":["སྔ་ཆ་","ཕྱི་ཆ་"],"day_name":["གཟའ་ཟླ་བ་","གཟའ་མིག་དམར་","གཟའ་ལྷག་པ་","གཟའ་ཕུར་བུ་","གཟའ་པ་སངས་","གཟའ་སྤེན་པ་","གཟའ་ཉི་མ་"],"day_short":["ཟླ་","མིར་","ལྷག་","ཕུར་","སངས་","སྤེན་","ཉི་"],"era":["BCE","CE"],"era_name":["BCE","CE"],"month_name":["ཟླ་དངཔ་","ཟླ་གཉིས་པ་","ཟླ་གསུམ་པ་","ཟླ་བཞི་པ་","ཟླ་ལྔ་པ་","ཟླ་དྲུག་པ","ཟླ་བདུན་པ་","ཟླ་བརྒྱད་པ་","ཟླ་དགུ་པ་","ཟླ་བཅུ་པ་","ཟླ་བཅུ་གཅིག་པ་","ཟླ་བཅུ་གཉིས་པ་"],"month_short":["༡","༢","༣","༤","༥","༦","༧","༨","༩","༡༠","༡༡","12"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "འབྲུག" };
	...
	icu.getLanguageName = function() { return "རྫོང་ཁ" };
	icu.getLocale = function() { return "dz-BT" };
	icu.getLocaleName = function() { return "རྫོང་ཁ། (འབྲུག།)" };
