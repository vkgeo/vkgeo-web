(function() {
	...
	icu.getCountry = function() { return "SH" };
	icu.getCountryName = function() { return "St. Helena" };
	...
	icu.getLocale = function() { return "en-SH" };
	icu.getLocaleName = function() { return "English (St. Helena)" };
