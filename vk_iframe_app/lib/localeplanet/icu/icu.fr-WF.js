(function() {
	...
	icu.getCountry = function() { return "WF" };
	icu.getCountryName = function() { return "Wallis-et-Futuna" };
	...
	icu.getLocale = function() { return "fr-WF" };
	icu.getLocaleName = function() { return "français (Wallis-et-Futuna)" };
