(function() {
	...
	icu.getCountryName = function() { return "Italien" };
	...
	icu.getLocale = function() { return "de-IT" };
	icu.getLocaleName = function() { return "Deutsch (Italien)" };
