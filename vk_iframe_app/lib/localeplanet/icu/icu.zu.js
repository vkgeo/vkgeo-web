(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["ISonto","UMsombuluko","ULwesibili","ULwesithathu","ULwesine","ULwesihlanu","UMgqibelo"],"day_short":["Son","Mso","Bil","Tha","Sin","Hla","Mgq"],"era":["BC","AD"],"era_name":["BC","AD"],"month_name":["Januwari","Februwari","Mashi","Ephreli","Meyi","Juni","Julayi","Agasti","Septhemba","Okthoba","Novemba","Disemba"],"month_short":["Jan","Feb","Mas","Eph","Mey","Jun","Jul","Aga","Sep","Okt","Nov","Dis"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
