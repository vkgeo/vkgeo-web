(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["Svondo","Muvhuro","Chipiri","Chitatu","China","Chishanu","Mugovera"],"day_short":["Svo","Muv","Chp","Cht","Chn","Chs","Mug"],"era":["BC","AD"],"era_name":["Kristo asati auya","mugore ramambo vedu"],"month_name":["Ndira","Kukadzi","Kurume","Kubvumbi","Chivabvu","Chikumi","Chikunguru","Nyamavhuvhu","Gunyana","Gumiguru","Mbudzi","Zvita"],"month_short":["Ndi","Kuk","Kur","Kub","Chv","Chk","Chg","Nya","Gun","Gum","Mbu","Zvi"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
