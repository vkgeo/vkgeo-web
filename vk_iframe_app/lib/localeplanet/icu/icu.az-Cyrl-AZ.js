(function() {
	...
	var dfs = {"am_pm":["АМ","ПМ"],"day_name":["базар","базар ертәси","чәршәнбә ахшамы","чәршәнбә","ҹүмә ахшамы","ҹүмә","шәнбә"],"day_short":["Б.","Б.Е.","Ч.А.","Ч.","Ҹ.А.","Ҹ.","Ш."],"era":["е.ә.","ј.е."],"era_name":["ерамыздан әввәл","јени ера"],"month_name":["јанвар","феврал","март","апрел","май","ијун","ијул","август","сентјабр","октјабр","нојабр","декабр"],"month_short":["јан","фев","мар","апр","май","ијн","ијл","авг","сен","окт","ној","дек"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLocaleName = function() { return "азәрбајҹан (Кирил, Азәрбајҹан)" };
