(function() {
	...
	var dfs = {"am_pm":["ip.","ep."],"day_name":["pasepeeivi","vuossaargâ","majebaargâ","koskoho","tuorâstuv","vástuppeeivi","lávurduv"],"day_short":["pas","vuo","maj","kos","tuo","vás","láv"],"era":["oKr.","mKr."],"era_name":["Ovdil Kristus šoddâm","maŋa Kristus šoddâm"],"month_name":["uđđâivemáánu","kuovâmáánu","njuhčâmáánu","cuáŋuimáánu","vyesimáánu","kesimáánu","syeinimáánu","porgemáánu","čohčâmáánu","roovvâdmáánu","skammâmáánu","juovlâmáánu"],"month_short":["uđiv","kuovâ","njuhčâ","cuáŋui","vyesi","kesi","syeini","porge","čohčâ","roovvâd","skammâ","juovlâ"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Suomâ" };
	...
	icu.getLanguage = function() { return "smn" };
	icu.getLanguageName = function() { return "anarâškielâ" };
	icu.getLocale = function() { return "smn-FI" };
	icu.getLocaleName = function() { return "anarâškielâ (Suomâ)" };
