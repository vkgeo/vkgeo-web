(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["snein","moandei","tiisdei","woansdei","tongersdei","freed","sneon"],"day_short":["si","mo","ti","wo","to","fr","so"],"era":["f.Kr.","n.Kr."],"era_name":["Foar Kristus","nei Kristus"],"month_name":["Jannewaris","Febrewaris","Maart","April","Maaie","Juny","July","Augustus","Septimber","Oktober","Novimber","Desimber"],"month_short":["Jan","Feb","Mrt","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Des"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Nederlân" };
	...
	icu.getLanguage = function() { return "fy" };
	icu.getLanguageName = function() { return "Frysk" };
	icu.getLocale = function() { return "fy-NL" };
	icu.getLocaleName = function() { return "Frysk (Nederlân)" };
