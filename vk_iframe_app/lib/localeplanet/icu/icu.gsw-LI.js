(function() {
	...
	icu.getCountryName = function() { return "Liächteschtäi" };
	...
	icu.getLocale = function() { return "gsw-LI" };
	icu.getLocaleName = function() { return "Schwiizertüütsch (Liächteschtäi)" };
