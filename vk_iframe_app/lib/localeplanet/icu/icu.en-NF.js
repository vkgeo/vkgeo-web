(function() {
	...
	icu.getCountry = function() { return "NF" };
	icu.getCountryName = function() { return "Norfolk Island" };
	...
	icu.getLocale = function() { return "en-NF" };
	icu.getLocaleName = function() { return "English (Norfolk Island)" };
