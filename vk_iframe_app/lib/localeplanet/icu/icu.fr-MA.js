(function() {
	...
	icu.getCountryName = function() { return "Maroc" };
	...
	icu.getLocale = function() { return "fr-MA" };
	icu.getLocaleName = function() { return "français (Maroc)" };
