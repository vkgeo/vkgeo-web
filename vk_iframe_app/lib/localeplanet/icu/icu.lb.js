(function() {
	...
	var dfs = {"am_pm":["moies","nomëttes"],"day_name":["Sonndeg","Méindeg","Dënschdeg","Mëttwoch","Donneschdeg","Freideg","Samschdeg"],"day_short":["Son.","Méi.","Dën.","Mët.","Don.","Fre.","Sam."],"era":["v. Chr.","n. Chr."],"era_name":["v. Chr.","n. Chr."],"month_name":["Januar","Februar","Mäerz","Abrëll","Mee","Juni","Juli","August","September","Oktober","November","Dezember"],"month_short":["Jan.","Feb.","Mäe.","Abr.","Mee","Juni","Juli","Aug.","Sep.","Okt.","Nov.","Dez."],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "lb" };
	icu.getLanguageName = function() { return "Lëtzebuergesch" };
	icu.getLocale = function() { return "lb" };
	icu.getLocaleName = function() { return "Lëtzebuergesch" };
