(function() {
	...
	icu.getCountry = function() { return "TV" };
	icu.getCountryName = function() { return "Tuvalu" };
	...
	icu.getLocale = function() { return "en-TV" };
	icu.getLocaleName = function() { return "English (Tuvalu)" };
