(function() {
	...
	icu.getCountry = function() { return "GM" };
	icu.getCountryName = function() { return "Gambia" };
	...
	icu.getLocale = function() { return "en-GM" };
	icu.getLocaleName = function() { return "English (Gambia)" };
