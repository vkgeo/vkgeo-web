(function() {
	...
	var dfs = {"am_pm":["چۈشتىن بۇرۇن","چۈشتىن كېيىن"],"day_name":["يەكشەنبە","دۈشەنبە","سەيشەنبە","چارشەنبە","پەيشەنبە","جۈمە","شەنبە"],"day_short":["يە","دۈ","سە","چا","پە","جۈ","شە"],"era":["BCE","مىلادىيە"],"era_name":["مىلادىيەدىن بۇرۇن","مىلادىيە"],"month_name":["يانۋار","فېۋرال","مارت","ئاپرېل","ماي","ئىيۇن","ئىيۇل","ئاۋغۇست","سېنتەبىر","ئۆكتەبىر","نويابىر","دېكابىر"],"month_short":["يانۋار","فېۋرال","مارت","ئاپرېل","ماي","ئىيۇن","ئىيۇل","ئاۋغۇست","سېنتەبىر","ئۆكتەبىر","نويابىر","دېكابىر"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "جۇڭگو" };
	...
	icu.getLanguageName = function() { return "ئۇيغۇرچە" };
	icu.getLocale = function() { return "ug-CN" };
	icu.getLocaleName = function() { return "ئۇيغۇرچە (جۇڭگو)" };
