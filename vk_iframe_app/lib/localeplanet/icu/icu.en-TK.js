(function() {
	...
	icu.getCountry = function() { return "TK" };
	icu.getCountryName = function() { return "Tokelau" };
	...
	icu.getLocale = function() { return "en-TK" };
	icu.getLocaleName = function() { return "English (Tokelau)" };
