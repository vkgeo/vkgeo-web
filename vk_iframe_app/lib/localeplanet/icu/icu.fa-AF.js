(function() {
	...
	var dfs = {"am_pm":["قبل\u200Cازظهر","بعدازظهر"],"day_name":["یکشنبه","دوشنبه","سه\u200Cشنبه","چهارشنبه","پنجشنبه","جمعه","شنبه"],"day_short":["یکشنبه","دوشنبه","سه\u200Cشنبه","چهارشنبه","پنجشنبه","جمعه","شنبه"],"era":["ه\u200D.ش."],"era_name":["هجری شمسی"],"month_name":["حمل","ثور","جوزا","سرطان","اسد","سنبلهٔ","میزان","عقرب","قوس","جدی","دلو","حوت"],"month_short":["فروردین","اردیبهشت","خرداد","تیر","مرداد","شهریور","مهر","آبان","آذر","دی","بهمن","اسفند"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
