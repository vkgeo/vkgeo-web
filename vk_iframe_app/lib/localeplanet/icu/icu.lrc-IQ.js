(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],"day_short":["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],"era":["BCE","CE"],"era_name":["BCE","CE"],"month_name":["جانڤیە","فئڤریە","مارس","آڤریل","مئی","جوٙأن","جوٙلا","آگوست","سئپتامر","ئوکتوڤر","نوڤامر","دئسامر"],"month_short":["جانڤیە","فئڤریە","مارس","آڤریل","مئی","جوٙأن","جوٙلا","آگوست","سئپتامر","ئوکتوڤر","نوڤامر","دئسامر"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "IQ" };
	...
	icu.getLanguage = function() { return "lrc" };
	icu.getLanguageName = function() { return "لۊری شومالی" };
	icu.getLocale = function() { return "lrc-IQ" };
	icu.getLocaleName = function() { return "لۊری شومالی (IQ)" };
