(function() {
	...
	var dfs = {"am_pm":["ЭИ","ЭК"],"day_name":["баскыһыанньа","бэнидиэнньик","оптуорунньук","сэрэдэ","чэппиэр","Бээтиҥсэ","субуота"],"day_short":["бс","бн","оп","сэ","чп","бэ","сб"],"era":["б. э. и.","б. э"],"era_name":["б. э. и.","б. э"],"month_name":["Тохсунньу","Олунньу","Кулун тутар","Муус устар","Ыам ыйын","Бэс ыйын","От ыйын","Атырдьых ыйын","Балаҕан ыйын","Алтынньы","Сэтинньи","ахсынньы"],"month_short":["Тохс","Олун","Клн","Мсу","Ыам","Бэс","Отй","Атр","Блҕ","Алт","Сэт","Ахс"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "sah" };
	icu.getLanguageName = function() { return "саха тыла" };
	icu.getLocale = function() { return "sah" };
	icu.getLocaleName = function() { return "саха тыла" };
