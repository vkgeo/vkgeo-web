(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["Jumapili","Jumatatu","Jumanne","Jumatano","Alhamisi","Ijumaa","Jumamosi"],"day_short":["Jumapili","Jumatatu","Jumanne","Jumatano","Alhamisi","Ijumaa","Jumamosi"],"era":["KK","BK"],"era_name":["Kabla ya Kristo","Baada ya Kristo"],"month_name":["Januari","Februari","Machi","Aprili","Mei","Juni","Julai","Agosti","Septemba","Oktoba","Novemba","Desemba"],"month_short":["Jan","Feb","Mac","Apr","Mei","Jun","Jul","Ago","Sep","Okt","Nov","Des"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLocale = function() { return "sw-CD" };
	icu.getLocaleName = function() { return "Kiswahili (Jamhuri ya Kidemokrasia ya Kongo)" };
