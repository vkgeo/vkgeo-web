(function() {
	...
	var dfs = {"am_pm":["pre podne","po podne"],"day_name":["nedelja","ponedeljak","utorak","sreda","četvrtak","petak","subota"],"day_short":["ned.","pon.","ut.","sr.","čet.","pet.","sub."],"era":["p. n. e.","n. e."],"era_name":["pre nove ere","nove ere"],"month_name":["januar","februar","mart","april","maj","jun","jul","avgust","septembar","oktobar","novembar","decembar"],"month_short":["jan.","feb.","mart","apr.","maj","jun","jul","avg.","sept.","okt.","nov.","dec."],"order_full":"DMY","order_long":"DMY","order_medium":"DMY","order_short":"DMY"};
	...
	icu.getCountryName = function() { return "Kosovo" };
	...
	icu.getLocale = function() { return "sr-Latn-XK" };
	icu.getLocaleName = function() { return "srpski (latinica, Kosovo)" };
