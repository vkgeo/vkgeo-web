(function() {
	...
	icu.getCountry = function() { return "SC" };
	icu.getCountryName = function() { return "Seychelles" };
	...
	icu.getLocale = function() { return "fr-SC" };
	icu.getLocaleName = function() { return "français (Seychelles)" };
