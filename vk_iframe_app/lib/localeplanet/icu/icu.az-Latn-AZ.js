(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["bazar","bazar ertəsi","çərşənbə axşamı","çərşənbə","cümə axşamı","cümə","şənbə"],"day_short":["B.","B.E.","Ç.A.","Ç.","C.A.","C.","Ş."],"era":["e.ə.","y.e."],"era_name":["eramızdan əvvəl","yeni era"],"month_name":["yanvar","fevral","mart","aprel","may","iyun","iyul","avqust","sentyabr","oktyabr","noyabr","dekabr"],"month_short":["yan","fev","mar","apr","may","iyn","iyl","avq","sen","okt","noy","dek"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguageName = function() { return "azərbaycan" };
	icu.getLocale = function() { return "az-Latn-AZ" };
	icu.getLocaleName = function() { return "azərbaycan (latın, Azərbaycan)" };
