(function() {
	...
	var dfs = {"am_pm":["上午","下午"],"day_name":["星期日","星期一","星期二","星期三","星期四","星期五","星期六"],"day_short":["周日","周一","周二","周三","周四","周五","周六"],"era":["西元前","西元"],"era_name":["西元前","西元"],"month_name":["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],"month_short":["1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "中华人民共和国" };
	...
	icu.getLanguage = function() { return "yue" };
	icu.getLanguageName = function() { return "粤语" };
	icu.getLocale = function() { return "yue-Hans-CN" };
	icu.getLocaleName = function() { return "粤语 (简体，中华人民共和国)" };
