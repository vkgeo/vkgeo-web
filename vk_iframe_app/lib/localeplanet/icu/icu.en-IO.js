(function() {
	...
	icu.getCountry = function() { return "IO" };
	icu.getCountryName = function() { return "British Indian Ocean Territory" };
	...
	icu.getLocale = function() { return "en-IO" };
	icu.getLocaleName = function() { return "English (British Indian Ocean Territory)" };
