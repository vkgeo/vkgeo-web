(function() {
	...
	icu.getCountry = function() { return "JE" };
	icu.getCountryName = function() { return "Jersey" };
	...
	icu.getLocale = function() { return "en-JE" };
	icu.getLocaleName = function() { return "English (Jersey)" };
