(function() {
	...
	var dfs = {"am_pm":["dopołdnja","popołdnju"],"day_name":["njedźela","póndźela","wutora","srjeda","štwórtk","pjatk","sobota"],"day_short":["nje","pón","wut","srj","štw","pja","sob"],"era":["př.Chr.n.","po Chr.n."],"era_name":["před Chrystowym narodźenjom","po Chrystowym narodźenju"],"month_name":["januara","februara","měrca","apryla","meje","junija","julija","awgusta","septembra","oktobra","nowembra","decembra"],"month_short":["jan.","feb.","měr.","apr.","mej.","jun.","jul.","awg.","sep.","okt.","now.","dec."],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Němska" };
	...
	icu.getLanguage = function() { return "hsb" };
	icu.getLanguageName = function() { return "hornjoserbšćina" };
	icu.getLocale = function() { return "hsb-DE" };
	icu.getLocaleName = function() { return "hornjoserbšćina (Němska)" };
