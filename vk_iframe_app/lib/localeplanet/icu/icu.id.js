(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["Minggu","Senin","Selasa","Rabu","Kamis","Jumat","Sabtu"],"day_short":["Min","Sen","Sel","Rab","Kam","Jum","Sab"],"era":["SM","M"],"era_name":["Sebelum Masehi","Masehi"],"month_name":["Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember"],"month_short":["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agt","Sep","Okt","Nov","Des"],"order_full":"YMD","order_long":"YMD","order_medium":"YMD","order_short":"YMD"};
	...
	icu.getLanguageName = function() { return "Indonesia" };
	icu.getLocale = function() { return "id" };
	icu.getLocaleName = function() { return "Indonesia" };
