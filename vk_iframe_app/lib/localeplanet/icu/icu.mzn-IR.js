(function() {
	...
	icu.getLanguage = function() { return "mzn" };
	icu.getLanguageName = function() { return "مازرونی" };
	icu.getLocale = function() { return "mzn-IR" };
	icu.getLocaleName = function() { return "مازرونی (ایران)" };
