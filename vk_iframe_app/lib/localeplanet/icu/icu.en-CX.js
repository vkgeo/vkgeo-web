(function() {
	...
	icu.getCountry = function() { return "CX" };
	icu.getCountryName = function() { return "Christmas Island" };
	...
	icu.getLocale = function() { return "en-CX" };
	icu.getLocaleName = function() { return "English (Christmas Island)" };
