(function() {
	...
	var dfs = {"am_pm":["AM","PM"],"day_name":["អាទិត្យ","ច័ន្ទ","អង្គារ","ពុធ","ព្រហស្បតិ៍","សុក្រ","សៅរ៍"],"day_short":["អាទិត្យ","ច័ន្ទ","អង្គារ","ពុធ","ព្រហស្បតិ៍","សុក្រ","សៅរ៍"],"era":["មុន គ.ស.","គ.ស."],"era_name":["មុន\u200Bគ្រិស្តសករាជ","គ្រិស្តសករាជ"],"month_name":["មករា","កុម្ភៈ","មីនា","មេសា","ឧសភា","មិថុនា","កក្កដា","សីហា","កញ្ញា","តុលា","វិច្ឆិកា","ធ្នូ"],"month_short":["មករា","កុម្ភៈ","មីនា","មេសា","ឧសភា","មិថុនា","កក្កដា","សីហា","កញ្ញា","តុលា","វិច្ឆិកា","ធ្នូ"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguageName = function() { return "ខ្មែរ" };
	icu.getLocale = function() { return "km" };
	icu.getLocaleName = function() { return "ខ្មែរ" };
