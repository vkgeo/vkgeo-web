(function() {
	...
	var dfs = {"am_pm":["m","f"],"day_name":["DiDòmhnaich","DiLuain","DiMàirt","DiCiadain","DiarDaoin","DihAoine","DiSathairne"],"day_short":["DiD","DiL","DiM","DiC","Dia","Dih","DiS"],"era":["RC","AD"],"era_name":["Ro Chrìosta","An dèidh Chrìosta"],"month_name":["dhen Fhaoilleach","dhen Ghearran","dhen Mhàrt","dhen Ghiblean","dhen Chèitean","dhen Ògmhios","dhen Iuchar","dhen Lùnastal","dhen t-Sultain","dhen Dàmhair","dhen t-Samhain","dhen Dùbhlachd"],"month_short":["Faoi","Gearr","Màrt","Gibl","Cèit","Ògmh","Iuch","Lùna","Sult","Dàmh","Samh","Dùbh"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "An Rìoghachd Aonaichte" };
	...
	icu.getLanguage = function() { return "gd" };
	icu.getLanguageName = function() { return "Gàidhlig" };
