(function() {
	...
	var dfs = {"am_pm":["ӕмбисбоны размӕ","ӕмбисбоны фӕстӕ"],"day_name":["хуыцаубон","къуырисӕр","дыццӕг","ӕртыццӕг","цыппӕрӕм","майрӕмбон","сабат"],"day_short":["хцб","крс","дцг","ӕрт","цпр","мрб","сбт"],"era":["н.д.а.","н.д."],"era_name":["н.д.а.","н.д."],"month_name":["январы","февралы","мартъийы","апрелы","майы","июны","июлы","августы","сентябры","октябры","ноябры","декабры"],"month_short":["янв.","фев.","мар.","апр.","майы","июны","июлы","авг.","сен.","окт.","ноя.","дек."],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Уӕрӕсе" };
	...
	icu.getLanguage = function() { return "os" };
	icu.getLanguageName = function() { return "ирон" };
	icu.getLocale = function() { return "os-RU" };
	icu.getLocaleName = function() { return "ирон (Уӕрӕсе)" };
