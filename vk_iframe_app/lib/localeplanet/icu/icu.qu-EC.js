(function() {
	...
	var dfs = {"am_pm":["a.m.","p.m."],"day_name":["Domingo","Lunes","Martes","Miércoles","Jueves","Viernes","Sábado"],"day_short":["Dom","Lun","Mar","Mié","Jue","Vie","Sab"],"era":["BCE","d.C."],"era_name":["BCE","d.C."],"month_name":["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Setiembre","Octubre","Noviembre","Diciembre"],"month_short":["Ene","Feb","Mar","Abr","May","Jun","Jul","Ago","Set","Oct","Nov","Dic"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "qu" };
	icu.getLanguageName = function() { return "Runasimi" };
	icu.getLocale = function() { return "qu-EC" };
	icu.getLocaleName = function() { return "Runasimi (Ecuador)" };
