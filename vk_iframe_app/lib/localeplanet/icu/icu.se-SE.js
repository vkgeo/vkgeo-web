(function() {
	...
	var dfs = {"am_pm":["iđitbeaivet","eahketbeaivet"],"day_name":["sotnabeaivi","vuossárga","maŋŋebárga","gaskavahkku","duorasdat","bearjadat","lávvardat"],"day_short":["sotn","vuos","maŋ","gask","duor","bear","láv"],"era":["o.Kr.","m.Kr."],"era_name":["ovdal Kristtusa","maŋŋel Kristtusa"],"month_name":["ođđajagemánnu","guovvamánnu","njukčamánnu","cuoŋománnu","miessemánnu","geassemánnu","suoidnemánnu","borgemánnu","čakčamánnu","golggotmánnu","skábmamánnu","juovlamánnu"],"month_short":["ođđj","guov","njuk","cuo","mies","geas","suoi","borg","čakč","golg","skáb","juov"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Ruoŧŧa" };
	...
	icu.getLanguageName = function() { return "davvisámegiella" };
	icu.getLocale = function() { return "se-SE" };
	icu.getLocaleName = function() { return "davvisámegiella (Ruoŧŧa)" };
