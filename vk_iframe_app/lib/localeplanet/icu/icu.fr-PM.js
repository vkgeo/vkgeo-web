(function() {
	...
	icu.getCountry = function() { return "PM" };
	icu.getCountryName = function() { return "Saint-Pierre-et-Miquelon" };
	...
	icu.getLocale = function() { return "fr-PM" };
	icu.getLocaleName = function() { return "français (Saint-Pierre-et-Miquelon)" };
