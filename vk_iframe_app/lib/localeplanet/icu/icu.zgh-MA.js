(function() {
	...
	icu.getLanguage = function() { return "zgh" };
	icu.getLanguageName = function() { return "ⵜⴰⵎⴰⵣⵉⵖⵜ" };
	icu.getLocale = function() { return "zgh-MA" };
	icu.getLocaleName = function() { return "ⵜⴰⵎⴰⵣⵉⵖⵜ (ⵍⵎⵖⵔⵉⴱ)" };
