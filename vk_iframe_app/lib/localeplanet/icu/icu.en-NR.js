(function() {
	...
	icu.getCountry = function() { return "NR" };
	icu.getCountryName = function() { return "Nauru" };
	...
	icu.getLocale = function() { return "en-NR" };
	icu.getLocaleName = function() { return "English (Nauru)" };
