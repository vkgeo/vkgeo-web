(function() {
	...
	var dfs = {"am_pm":["TO","TK"],"day_name":["yakshanba","dushanba","seshanba","chorshanba","payshanba","juma","shanba"],"day_short":["Yak","Dush","Sesh","Chor","Pay","Jum","Shan"],"era":["m.a.","milodiy"],"era_name":["miloddan avvalgi","milodiy"],"month_name":["yanvar","fevral","mart","aprel","may","iyun","iyul","avgust","sentabr","oktabr","noyabr","dekabr"],"month_short":["yan","fev","mar","apr","may","iyn","iyl","avg","sen","okt","noy","dek"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Oʻzbekiston" };
	...
	icu.getLanguageName = function() { return "o‘zbek" };
	icu.getLocale = function() { return "uz-Latn-UZ" };
	icu.getLocaleName = function() { return "o‘zbek (lotin, Oʻzbekiston)" };
