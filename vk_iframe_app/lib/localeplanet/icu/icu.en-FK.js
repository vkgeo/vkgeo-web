(function() {
	...
	icu.getCountry = function() { return "FK" };
	icu.getCountryName = function() { return "Falkland Islands" };
	...
	icu.getLocale = function() { return "en-FK" };
	icu.getLocaleName = function() { return "English (Falkland Islands)" };
