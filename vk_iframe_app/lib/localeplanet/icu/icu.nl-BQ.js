(function() {
	...
	icu.getCountry = function() { return "BQ" };
	icu.getCountryName = function() { return "Caribisch Nederland" };
	...
	icu.getLocale = function() { return "nl-BQ" };
	icu.getLocaleName = function() { return "Nederlands (Caribisch Nederland)" };
