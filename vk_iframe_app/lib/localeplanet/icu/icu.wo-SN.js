(function() {
	...
	var dfs = {"am_pm":["Sub","Ngo"],"day_name":["Dibéer","Altine","Talaata","Àlarba","Alxamis","Àjjuma","Aseer"],"day_short":["Dib","Alt","Tal","Àla","Alx","Àjj","Ase"],"era":["JC","AD"],"era_name":["av. JC","AD"],"month_name":["Samwiyee","Fewriyee","Mars","Awril","Mee","Suwe","Sulet","Ut","Sàttumbar","Oktoobar","Nowàmbar","Desàmbar"],"month_short":["Sam","Few","Mar","Awr","Mee","Suw","Sul","Ut","Sàt","Okt","Now","Des"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLocale = function() { return "wo-SN" };
	icu.getLocaleName = function() { return "Wolof (Senegaal)" };
