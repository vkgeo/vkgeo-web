(function() {
	...
	icu.getCountry = function() { return "CK" };
	icu.getCountryName = function() { return "Cook Islands" };
	...
	icu.getLocale = function() { return "en-CK" };
	icu.getLocaleName = function() { return "English (Cook Islands)" };
