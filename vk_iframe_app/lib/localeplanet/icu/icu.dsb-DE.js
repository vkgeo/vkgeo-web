(function() {
	...
	var dfs = {"am_pm":["dopołdnja","wótpołdnja"],"day_name":["njeźela","pónjeźele","wałtora","srjoda","stwórtk","pětk","sobota"],"day_short":["nje","pón","wał","srj","stw","pět","sob"],"era":["pś.Chr.n.","pó Chr.n."],"era_name":["pśed Kristusowym naroźenim","pó Kristusowem naroźenju"],"month_name":["januara","februara","měrca","apryla","maja","junija","julija","awgusta","septembra","oktobra","nowembra","decembra"],"month_short":["jan.","feb.","měr.","apr.","maj.","jun.","jul.","awg.","sep.","okt.","now.","dec."],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Nimska" };
	...
	icu.getLanguage = function() { return "dsb" };
	icu.getLanguageName = function() { return "dolnoserbšćina" };
	icu.getLocale = function() { return "dsb-DE" };
	icu.getLocaleName = function() { return "dolnoserbšćina (Nimska)" };
