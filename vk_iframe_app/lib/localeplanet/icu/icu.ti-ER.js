(function() {
	...
	var dfs = {"am_pm":["ንጉሆ ሰዓተ","ድሕር ሰዓት"],"day_name":["ሰንበት","ሰኑይ","ሠሉስ","ረቡዕ","ኃሙስ","ዓርቢ","ቀዳም"],"day_short":["ሰን","ሰኑ","ሰሉ","ረቡ","ሓሙ","ዓር","ቀዳ"],"era":["ዓ\/ዓ","ዓ\/ም"],"era_name":["ዓመተ ዓለም","ዓመተ ምህረት"],"month_name":["ጥሪ","ለካቲት","መጋቢት","ሚያዝያ","ግንቦት","ሰነ","ሓምለ","ነሓሰ","መስከረም","ጥቅምቲ","ሕዳር","ታሕሳስ"],"month_short":["ጥሪ","ለካ","መጋ","ሚያ","ግን","ሰነ","ሓም","ነሓ","መስ","ጥቅ","ሕዳ","ታሕ"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "ኤርትራ" };
	...
	icu.getLocaleName = function() { return "ትግርኛ (ኤርትራ)" };
