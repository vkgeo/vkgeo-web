(function() {
	...
	var dfs = {"am_pm":["פֿאַרמיטאָג","נאָכמיטאָג"],"day_name":["זונטיק","מאָנטיק","דינסטיק","מיטוואך","דאנערשטיק","פֿרײַטיק","שבת"],"day_short":["זונטיק","מאָנטיק","דינסטיק","מיטוואך","דאנערשטיק","פֿרײַטיק","שבת"],"era":["BCE","CE"],"era_name":["BCE","CE"],"month_name":["יאַנואַר","פֿעברואַר","מערץ","אַפּריל","מיי","יוני","יולי","אויגוסט","סעפּטעמבער","אקטאבער","נאוועמבער","דעצעמבער"],"month_short":["יאַנואַר","פֿעברואַר","מערץ","אַפּריל","מיי","יוני","יולי","אויגוסט","סעפּטעמבער","אקטאבער","נאוועמבער","דעצעמבער"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "וועלט" };
	...
	icu.getLanguageName = function() { return "ייִדיש" };
	icu.getLocale = function() { return "yi-001" };
	icu.getLocaleName = function() { return "ייִדיש (וועלט)" };
