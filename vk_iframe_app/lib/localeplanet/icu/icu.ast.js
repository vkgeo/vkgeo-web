(function() {
	...
	var dfs = {"am_pm":["de la mañana","de la tarde"],"day_name":["domingu","llunes","martes","miércoles","xueves","vienres","sábadu"],"day_short":["dom","llu","mar","mié","xue","vie","sáb"],"era":["e.C.","d.C."],"era_name":["enantes de Cristu","después de Cristu"],"month_name":["de xineru","de febreru","de marzu","d\u2019abril","de mayu","de xunu","de xunetu","d\u2019agostu","de setiembre","d\u2019ochobre","de payares","d\u2019avientu"],"month_short":["xin","feb","mar","abr","may","xun","xnt","ago","set","och","pay","avi"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getLanguage = function() { return "ast" };
	icu.getLanguageName = function() { return "asturianu" };
	icu.getLocale = function() { return "ast" };
	icu.getLocaleName = function() { return "asturianu" };
