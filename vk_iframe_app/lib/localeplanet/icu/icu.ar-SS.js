(function() {
	...
	icu.getCountry = function() { return "SS" };
	icu.getCountryName = function() { return "جنوب السودان" };
	...
	icu.getLocale = function() { return "ar-SS" };
	icu.getLocaleName = function() { return "العربية (جنوب السودان)" };
