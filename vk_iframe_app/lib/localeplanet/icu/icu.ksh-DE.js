(function() {
	...
	var dfs = {"am_pm":["Uhr vörmiddaachs","Uhr nommendaachs"],"day_name":["Sunndaach","Mohndaach","Dinnsdaach","Metwoch","Dunnersdaach","Friidaach","Samsdaach"],"day_short":["Su.","Mo.","Di.","Me.","Du.","Fr.","Sa."],"era":["v. Chr.","n. Chr."],"era_name":["vür Krestos","noh Krestos"],"month_name":["Jannewa","Fäbrowa","Määz","Aprell","Mai","Juuni","Juuli","Oujoß","Septämber","Oktohber","Novämber","Dezämber"],"month_short":["Jan","Fäb","Mäz","Apr","Mai","Jun","Jul","Ouj","Säp","Okt","Nov","Dez"],"order_full":"MDY","order_long":"MDY","order_medium":"MDY","order_short":"MDY"};
	...
	icu.getCountryName = function() { return "Doütschland" };
	...
	icu.getLanguage = function() { return "ksh" };
	icu.getLanguageName = function() { return "Kölsch" };
